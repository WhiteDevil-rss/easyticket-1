                            ...
                            <div class="info-area">
                                <div class="info-item">
                                    <div class="info-thumb">
                                         <img src="{{url('public/frontend/images/contact/contact01.png')}}" alt="contact">
                                    </div>
                                ...
                                <div class="info-item">
                                    <div class="info-thumb">
                                         <img src="{{url('public/frontend/images/contact/contact02.png')}}" alt="contact">
                                    </div>
                                    <div class="info-content">
                                        <h6 class="title">Email</h6>
                                        <a href="Mailto:info@gmail.com"><span class="__cf_email__" data-cfemail="c4adaaa2ab8486aba8a1b0ab">[email&#160;protected]</span> .com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
