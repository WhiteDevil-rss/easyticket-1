...
@section('main-container')
    <!-- ==========Banner-Section========== -->
    <section class="main-page-header speaker-banner bg_img" data-background="{{url('public/frontend/images/banner/banner04.jpg')}}">
        <div class="container">
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    <div class="event-about-content">
                        <div class="section-header-3 left-style m-0">
                            <span class="cate">we are {{ env('APP_NAME') }} </span>
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="about-thumb">
                         <img src="{{url('public/frontend/images/about/about01.png')}}" alt="about">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-9 offset-lg-3 bg-two">
                    <div class="philosophy-content">
                        ...
                        <ul class="phisophy-list">
                            <li>
                                <div class="thumb">
                                     <img src="{{url('public/frontend/images/philosophy/icon1.png')}}" alt="philosophy">
                                </div>
                                <h5 class="title">Honesty & Fairness </h5>
                            </li>
                            <li>
                                <div class="thumb">
                                     <img src="{{url('public/frontend/images/philosophy/icon2.png')}}" alt="philosophy">
                                </div>
                                <h5 class="title">Clarity & Transparency</h5>
                            </li>
                            <li>
                                <div class="thumb">
                                     <img src="{{url('public/frontend/images/philosophy/icon3.png')}}" alt="philosophy">
                                </div>
                    ...
                    <div class="about-counter">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                 <img src="{{url('public/frontend/images/about/about-counter01.png')}}" alt="about">
                            </div>
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                 <img src="{{url('public/frontend/images/about/about-counter02.png')}}" alt="about">
                            </div>
                            <div class="counter-content">
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                 <img src="{{url('public/frontend/images/about/about-counter03.png')}}" alt="about">
                            </div>
                            <div class="counter-content">
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                 <img src="{{url('public/frontend/images/about/about-counter04.png')}}" alt="about">
                            </div>
                            <div class="counter-content">
            ...
            <div class="client-slider owl-carousel owl-theme">
                <div class="client-item">
                    <div class="client-thumb">
                         <img src="{{url('public/frontend/images/client/client01.jpg')}}" alt="client">
                    </div>
                ...
                <div class="client-item">
                    <div class="client-thumb">
                         <img src="{{url('public/frontend/images/client/client03.jpg')}}" alt="client">
                    </div>
                    <div class="client-content">
                        <h5 class="title">
                            <a href="#0">Rudra</a>
                ...
                <div class="client-item">
                    <div class="client-thumb">
                         <img src="{{url('public/frontend/images/client/client02.jpg')}}" alt="client">
                    </div>
                    <div class="client-content">
                        <h5 class="title">
                            <a href="#0">Raihan</a>
                ...
                <div class="client-item">
                    <div class="client-thumb">
                         <img src="{{url('public/frontend/images/client/client04.jpg')}}" alt="client">
                    </div>
                    <div class="client-content">
                        <h5 class="title">
                            <a href="#0">Shahidul</a>
            ...
            <div class="speaker--slider">
                <div class="speaker-slider owl-carousel owl-theme">
                    <div class="speaker-item">
                        <div class="speaker-thumb">
                            <a href="event-speaker.html">
                                 <img src="{{url('public/frontend/images/speaker/speaker01.jpg')}}" alt="speaker">
                            </a>
                        </div>
                    ...
                    <div class="speaker-item">
                        <div class="speaker-thumb">
                            <a href="event-speaker.html">
                                 <img src="{{url('public/frontend/images/speaker/speaker02.jpg')}}" alt="speaker">
                            </a>
                        </div>
                        <div class="speaker-content">
                            <h5 class="title">
                    ...
                    <div class="speaker-item">
                        <div class="speaker-thumb">
                            <a href="event-speaker.html">
                                 <img src="{{url('public/frontend/images/speaker/speaker03.jpg')}}" alt="speaker">
                            </a>
                        </div>
                        <div class="speaker-content">
                            <h5 class="title">
                    ...
                    <div class="speaker-item">
                        <div class="speaker-thumb">
                            <a href="event-speaker.html">
                                 <img src="{{url('public/frontend/images/speaker/speaker04.jpg')}}" alt="speaker">
                            </a>
                        </div>
                        <div class="speaker-content">
                            <h5 class="title">
                    ...
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            <a href="assets/images/gallery/gallery05.jpg" class="img-pop">
                             ...
                             <img src="{{url('public/frontend/images/gallery/gallery05.jpg')}}" alt="gallery">
                        </div>
                    </div>
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            <a href="assets/images/gallery/gallery06.jpg" class="img-pop">
                             ...
                             <img src="{{url('public/frontend/images/gallery/gallery06.jpg')}}" alt="gallery">
                        </div>
                    </div>
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            <a href="assets/images/gallery/gallery07.jpg" class="img-pop">
                             ...
                             <img src="{{url('public/frontend/images/gallery/gallery07.jpg')}}" alt="gallery">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            <a href="assets/images/gallery/gallery11.jpg" class="img-pop">
                             ...
                             <img src="{{url('public/frontend/images/gallery/gallery11.jpg')}}" alt="gallery">
                        </div>
                    </div>
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            <a href="assets/images/gallery/gallery12.jpg" class="img-pop">
                             ...
                             <img src="{{url('public/frontend/images/gallery/gallery12.jpg')}}" alt="gallery">
                        </div>
                    </div>
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            <a href="assets/images/gallery/gallery13.jpg" class="img-pop">
                             ...
                             <img src="{{url('public/frontend/images/gallery/gallery13.jpg')}}" alt="gallery">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            <a href="assets/images/gallery/gallery08.jpg" class="img-pop">
                             ...
                             <img src="{{url('public/frontend/images/gallery/gallery08.jpg')}}" alt="gallery">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="gallery-item two">
                                <div class="gallery-thumb">
                                    <a href="assets/images/gallery/gallery09.jpg" class="img-pop">
                                     ...
                                     <img src="{{url('public/frontend/images/gallery/gallery09.jpg')}}" alt="gallery">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="gallery-item two">
                                <div class="gallery-thumb">
                                    <a href="assets/images/gallery/gallery10.jpg" class="img-pop">
                                     ...
                                     <img src="{{url('public/frontend/images/gallery/gallery10.jpg')}}" alt="gallery">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="tour-content">
                        ...
                        <ul class="list-tour">
                            <li>
                                <div class="thumb">
                                     <img src="{{url('public/frontend/images/tour/icon01.png')}}" alt="tour">
                                </div>
                                <div class="content">
                            ...
                            <li>
                                <div class="thumb">
                                     <img src="{{url('public/frontend/images/tour/icon02.png')}}" alt="tour">
                                </div>
                                <div class="content">
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="tour-thumb">
                         <img src="{{url('public/frontend/images/tour/tour.png')}}" alt="tour">
                    </div>
                </div>
            </div>
        </div>
