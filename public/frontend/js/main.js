(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".seat-free img").on('click', function(e) {
      if($(this).attr('booked') == '0') {
        $(this).attr("src",base_url+"/public/frontend/images/movie/seat01-free.png");
        $(this).attr('booked','');
        console.log($(this).attr('booked'));
      }
      else if($(this).attr('booked') == '') {
        $(this).attr("src",base_url+"/public/frontend/images/movie/seat01-booked.png");
        $(this).attr('booked',0);
        console.log($(this).attr('booked'));
      }
    });
    $(".seat-free-two img").on('click', function(e) {
      if($(this).attr('booked') == '0') {
        $(this).attr("src",base_url+"/public/frontend/images/movie/seat02-free.png");
        $(this).attr('booked') = 1;
      }
      else if($(this).attr('booked') == '1') {
        $(this).attr("src",base_url+"/public/frontend/images/movie/seat02-booked.png");
        $(this).attr('booked') = 0;
      }
    });
    ...
    $(".seat-free img").on('click', function(e) {
      var seat_no = $(this).attr('seatno');
      var price  = $(this).attr('price');
      //remove existing item from array of seats
      console.log( seats.indexOf(seat_no));
      var index = seats.indexOf(seat_no);
      if (index > -1) {
      ...
      //add new item to array of seats
      $(".choosed_seat").html(seats.join(", "));
      console.log(seats);
      $('#selected_seats').val(seats);
      $('#totalprice').val(totalprice);
      setCookie('seats', seats, 1);
      $('#store_seats_data').val(seats);
    });
